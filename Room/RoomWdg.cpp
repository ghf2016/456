	...
	: CCommonWidget(parent, WndFlag, Qt::Dialog)
{
	...
	m_bMicMute = true;
	m_bSpeakerMute = true;
	this->setFocusPolicy(Qt::StrongFocus);     //Qt::StrongFocus	TabFocus | ClickFocus | 0x8	接受Tab键和鼠标单击做焦点，相当于选中这个节面
	ui.setupUi(this);
	...
	m_pLabelNetInfo->setPixmap(QPixmap(":/skin/room/wlzl_1.png"));            //网络质量的图 固定的？
